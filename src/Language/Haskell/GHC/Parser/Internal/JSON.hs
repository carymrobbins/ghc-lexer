...
stubToJSON' :: Text -> a -> Value
stubToJSON' t _ = object [ t .= emptyArray ]

stubToJSON :: forall a. Typeable a => a -> Value
stubToJSON a = stubToJSON' (T.pack $ show $ typeOf a) a
...
instance ToJSON (HsDecl GT) where toJSON = defaultToJSON

deriving instance Generic (ImportDecl pass)
instance ToJSON (ImportDecl GP) where toJSON = defaultToJSON
instance ToJSON (ImportDecl GR) where toJSON = defaultToJSON
instance ToJSON (ImportDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (IE GT) where toJSON = defaultToJSON
...
instance ToJSON (HsBindLR GT GT) where toJSON = defaultToJSON
...
instance ToJSON (SpliceDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (RuleDecls GT) where toJSON = defaultToJSON
...
instance ToJSON (AnnDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (PatSynBind GT GT) where toJSON = defaultToJSON

deriving instance Generic Role
instance ToJSON Role where toJSON = defaultToJSON

deriving instance Generic CmdTopTc
instance ToJSON CmdTopTc where toJSON = defaultToJSON
...
instance ToJSON (HsSplice GT) where toJSON = defaultToJSON
...
instance ToJSON (RuleDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (WarnDecls GT) where toJSON = defaultToJSON
...
instance (ToJSON body) => ToJSON (GRHSs GT body) where toJSON = defaultToJSON
...
deriving instance Generic RecordUpdTc
instance ToJSON RecordUpdTc where toJSON = defaultToJSON

deriving instance Generic ListPatTc
instance ToJSON ListPatTc where toJSON = defaultToJSON

deriving instance Generic RecStmtTc
instance ToJSON RecStmtTc where toJSON = defaultToJSON

deriving instance Generic OverLitTc
instance ToJSON OverLitTc where toJSON = defaultToJSON
...
instance ToJSON (ForeignDecl GT) where toJSON = defaultToJSON
...
instance (ToJSON body) => ToJSON (MatchGroup GT body) where toJSON = defaultToJSON

deriving instance Generic MatchGroupTc
instance ToJSON MatchGroupTc where toJSON = defaultToJSON
...
instance ToJSON (DefaultDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (Sig GT) where toJSON = defaultToJSON

deriving instance Generic NPatBindTc
instance ToJSON NPatBindTc where toJSON = defaultToJSON
...
instance ToJSON (DerivDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (ABExport GT) where toJSON = defaultToJSON
...
instance ToJSON (Pat GT) where toJSON = defaultToJSON
...
instance ToJSON (HsSplicedThing GT) where toJSON = defaultToJSON
...
instance ToJSON (RuleBndr GT) where toJSON = defaultToJSON
...
instance ToJSON (WarnDecl GT) where toJSON = defaultToJSON
...
instance (ToJSON body) => ToJSON (GRHS GT body) where toJSON = defaultToJSON
...
instance (ToJSON body) => ToJSON (StmtLR GT GT body) where toJSON = defaultToJSON
...
instance (ToJSON body) => ToJSON (HsImplicitBndrs GT body) where toJSON = defaultToJSON
...
instance (ToJSON body) => ToJSON (Match GT body) where toJSON = defaultToJSON
...
instance ToJSON (HsPatSynDir GT) where toJSON = defaultToJSON
...
instance ToJSON (HsLocalBindsLR GT GT) where toJSON = defaultToJSON
...
instance (ToJSON body) => ToJSON (HsRecFields GT body) where toJSON = defaultToJSON
...
instance (ToJSON thing) => ToJSON (HsWildCardBndrs GT thing) where toJSON = defaultToJSON
...
instance ToJSON (AmbiguousFieldOcc GT) where toJSON = defaultToJSON
...
instance ToJSON (HsType GT) where toJSON = defaultToJSON
...
instance ToJSON (HsOverLit GT) where toJSON = defaultToJSON
...
instance ToJSON (HsLit GT) where toJSON = defaultToJSON
...
instance ToJSON (SyntaxExpr GT) where toJSON = defaultToJSON
...
instance ToJSON (HsTupArg GT) where toJSON = defaultToJSON
...
instance ToJSON (FixitySig GT) where toJSON = defaultToJSON
...
instance ToJSON (DerivStrategy GT) where toJSON = defaultToJSON
...
instance (ToJSON pats, ToJSON rhs) => ToJSON (FamEqn GT pats rhs) where toJSON = defaultToJSON
...
instance ToJSON (ArithSeqInfo GT) where toJSON = defaultToJSON
...
instance ToJSON (DataFamInstDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (HsBracket GT) where toJSON = defaultToJSON
...
instance ToJSON (TyFamInstDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (HsCmdTop GT) where toJSON = defaultToJSON
...
instance ToJSON (HsDataDefn GT) where toJSON = defaultToJSON
...
instance ToJSON (LHsQTyVars GT) where toJSON = defaultToJSON
...
instance ToJSON (FamilyDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (ParStmtBlock GT GT) where toJSON = defaultToJSON
...
instance ToJSON (ApplicativeArg GT) where toJSON = defaultToJSON
...
instance ToJSON (HsValBindsLR GT GT) where toJSON = defaultToJSON
...
instance ToJSON (HsIPBinds GT) where toJSON = defaultToJSON
...
instance ToJSON (FieldOcc GT) where toJSON = defaultToJSON
...
instance ToJSON (ConDeclField GT) where toJSON = defaultToJSON
...
instance ToJSON (HsTyVarBndr GT) where toJSON = defaultToJSON
...
instance ToJSON (HsGroup GT) where toJSON = defaultToJSON
...
instance ToJSON (HsCmd GT) where toJSON = defaultToJSON
...
instance ToJSON (ConDecl GT) where toJSON = defaultToJSON
...
instance ToJSON (HsDerivingClause GT) where toJSON = defaultToJSON
...
instance ToJSON (FamilyInfo GT) where toJSON = defaultToJSON
...
instance ToJSON (FamilyResultSig GT) where toJSON = defaultToJSON
...
deriving instance Generic RecordConTc
instance ToJSON RecordConTc where toJSON = defaultToJSON
...
instance ToJSON MkId.DataConBoxer where
  toJSON _ = object [ "DataConBoxer" .= emptyArray ]

-- TODO: I have no idea how to deal with IORef. Why is there an IORef in
-- the parse tree?
ioRefToJSON' :: Text -> IORef a -> Value
ioRefToJSON' t _ = object [ "IORef" .= [t] ]

ioRefToJSON :: forall a. Typeable a => IORef a -> Value
ioRefToJSON = ioRefToJSON' $ T.pack $ show $ typeRep (Proxy @a)

instance Typeable a => ToJSON (IORef a) where toJSON = ioRefToJSON
--instance ToJSON (IORef VarSet.CoVarSet) where toJSON = ioRefToJSON "CoVarSet"
--instance ToJSON (IORef EvBindMap) where toJSON = ioRefToJSON "EvBindMap"

-- TODO: Can't get to UniqDFM.TaggedVal, so just stubbing UniqDFM for now.
-- $(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''UniqDFM.UniqDFM)
-- $(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''UniqDFM.TaggedVal)
instance Typeable a => ToJSON (UniqDFM.UniqDFM a) where toJSON = stubToJSON

-- NB: I don't think we need to do 'object [ "GHC.Arr.Array" .= ... ]' here; this should produce
-- a [(i, e)] to encode to JSON, which should end up being nested JSON arrays,
-- e.g. [[i_0, e_0], ..., [i_n, e_n]], instead of a JSON object.
instance (GHC.Arr.Ix i, ToJSON i, ToJSON e) => ToJSON (GHC.Arr.Array i e) where
  toJSON = toJSON . GHC.Arr.assocs

-- TODO: Hack for CoAxiom.coaxrProves; can probably just omit this field in the rendered
-- JSON, but for now we'll stub it to avoid writing the CoAxiomCoAxiomRule instance by hand.
instance ToJSON ([CoAxiom.TypeEqn] -> Maybe CoAxiom.TypeEqn) where toJSON = stubToJSON

-- TODO: Hack for RuntimeRepInfo; can probably omit this field in the rendered json...
instance ToJSON ([Type] -> [TyCon.PrimRep]) where toJSON = stubToJSON

-- TODO: Ok we need ClassBody, but it's not exported and seems tough to get at, will probably need
-- to fork the GHC parser to get at it.
instance ToJSON Class where toJSON = stubToJSON
...
$(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''UniqFM.UniqFM)
$(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''TupleSort)
$(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''TyCon.TyConFlavour)
...
$(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''CoAxiom.CoAxBranch)
$(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''CoreSyn.Expr)
$(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''CoreSyn.Bind)
$(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''CoreSyn.AltCon)
...
$(deriveToJSON defaultOptions { sumEncoding = ObjectWithSingleField } ''TyCon.PrimElemRep)
